...
parser.add_argument("--num-iters", type=int, default=20, help="number of benchmark iterations")
...
print(
    ...
    % (args.num_gpus, device, img_sec_mean, args.num_gpus * img_sec_conf)  # we do NOT scale this by number workers
)
