"""MobileNetV2 for CIFAR10/100

Reference:
Sandler, Mark, et al. MobileNetV2: Inverted Residuals and Linear Bottlenecks (CVPR '18)
"""
import torch
...
def mobilenetv2(Dataset):
    return MobileNetV2(Dataset)
