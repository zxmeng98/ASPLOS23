"""ShuffleNetV2 for CIFAR10/100

Reference:
Ma, Ningning, et al. ShuffleNet V2: Practical Guidelines for Efficient CNN Architecture Design (ECCV '18)
"""
...
def shufflenetv2(Dataset):
    return ShuffleNetV2(Dataset)
