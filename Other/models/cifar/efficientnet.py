"""EfficientNet for CIFAR10/100

Reference:
Tan, Mingxing, et al. EfficientNet: Rethinking Model Scaling for Convolutional Neural Networks (ICML '19)
"""
...
def efficientnet(Dataset):
    ...
    return EfficientNet(Dataset, cfg)
